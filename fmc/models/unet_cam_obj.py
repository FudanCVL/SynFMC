...
class UNet3DConditionModelCamObjCond(UNet3DConditionModel):
    _supports_gradient_checkpointing = True
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(UNet3DConditionModelCamObjCond, self).__init__(**kwargs)
        self.decoder_add_posecond = decoder_add_posecond


    def debug_set_motion_attn_processor(self,add_spatial=False,
    ...
    def forward(
            ...
            traj_features: List[torch.Tensor] = None,
            return_dict: bool = True,
        ...
        for downsample_block, pose_embedding_feature, down_fuser, motion_module_alpha in zip(self.down_blocks,
            ...
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                sample, res_samples = downsample_block(
                    ...
                    attention_mask=attention_mask,
                    motion_module_alpha=motion_module_alpha,
                    cross_attention_kwargs=cross_attention_kwargs.update({"pose_feature": pose_embedding_feature,"traj_features":traj_features})
                    if cross_attention_kwargs is not None else {"pose_feature": pose_embedding_feature,"traj_features":traj_features},
