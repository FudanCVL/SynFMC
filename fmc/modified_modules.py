...
def Adapted_CrossAttnDownBlock3D_forward(self, hidden_states, temb=None, encoder_hidden_states=None, attention_mask=None,
                motion_module_alpha=1., cross_attention_kwargs={}, motion_cross_attention_kwargs={}):
    if 'traj_features' in cross_attention_kwargs:
        traj_features = cross_attention_kwargs['traj_features']
        cross_attention_kwargs.pop('traj_features')
    else:
        traj_features = None
...
def Adapted_DownBlock3D_forward(self, hidden_states, temb=None, encoder_hidden_states=None, motion_module_alpha=1.,motion_cross_attention_kwargs={}, **kwargs):
